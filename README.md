...
Some modules need to explain the code in documentation, and I don't like to do these meaningless things, so code this project and use the  GPT-3 artificial intelligence model's powerful code explanation ability to help me complete the task. If this project helps you, star it please! Thank you!
